...
public class BDMapView extends AppCompatActivity {
...
//        } else {
//            //获取一个Notification构造器
//            Notification.Builder builder = new Notification.Builder(BDMapView.this);
//            Intent nfIntent = new Intent(BDMapView.this, BDMapView.class);
//
//            builder.setContentIntent(PendingIntent.
//                    getActivity(BDMapView.this, 0, nfIntent, 0)) // 设置PendingIntent
